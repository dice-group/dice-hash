...
// Example:
//
//     float y = Dice::hash::wyhash::Uint128Max();  // Error. uint128 cannot be implicitly
//                                    // converted to float.
//
//     Dice::hash::wyhash::uint128 v;
//     uint64_t i = v;                         // Error
...
class
 ...
 public:
  ...
  // Example:
  //
  //   Dice::hash::wyhash::uint128 big = Dice::hash::wyhash::MakeUint128(1, 0);
  ...
  // Support for Dice::hash::wyhash::Hash.
  template <typename H>
...
namespace std {
template <>
class numeric_limits<Dice::hash::wyhash::uint128> {
 public:
  ...
  static constexpr Dice::hash::wyhash::uint128 (min)() { return 0; }
  static constexpr Dice::hash::wyhash::uint128 lowest() { return 0; }
  static constexpr Dice::hash::wyhash::uint128 (max)() { return Dice::hash::wyhash::Uint128Max(); }
  static constexpr Dice::hash::wyhash::uint128 epsilon() { return 0; }
  static constexpr Dice::hash::wyhash::uint128 round_error() { return 0; }
  static constexpr Dice::hash::wyhash::uint128 infinity() { return 0; }
  static constexpr Dice::hash::wyhash::uint128 quiet_NaN() { return 0; }
  static constexpr Dice::hash::wyhash::uint128 signaling_NaN() { return 0; }
  static constexpr Dice::hash::wyhash::uint128 denorm_min() { return 0; }
};
}  // namespace std
...
// Example:
//
//     float y = Dice::hash::wyhash::int128(17);  // Error. int128 cannot be implicitly
//                                  // converted to float.
//
//     Dice::hash::wyhash::int128 v;
//     int64_t i = v;                        // Error
...
class int128 {
 public:
  ...
  //
  //   (Dice::hash::wyhash::int128(1) << 64) * high + low
  //
  ...
  // Example:
  //
  //   Dice::hash::wyhash::int128 big = Dice::hash::wyhash::MakeInt128(1, 0);
  //   Dice::hash::wyhash::int128 big_n = Dice::hash::wyhash::MakeInt128(-1, 0);
...
namespace std {
template <>
class numeric_limits<Dice::hash::wyhash::int128> {
 public:
  static constexpr bool is_specialized = true;
  ...
  static constexpr Dice::hash::wyhash::int128 (min)() { return Dice::hash::wyhash::Int128Min(); }
  static constexpr Dice::hash::wyhash::int128 lowest() { return Dice::hash::wyhash::Int128Min(); }
  static constexpr Dice::hash::wyhash::int128 (max)() { return Dice::hash::wyhash::Int128Max(); }
  static constexpr Dice::hash::wyhash::int128 epsilon() { return 0; }
  static constexpr Dice::hash::wyhash::int128 round_error() { return 0; }
  static constexpr Dice::hash::wyhash::int128 infinity() { return 0; }
  static constexpr Dice::hash::wyhash::int128 quiet_NaN() { return 0; }
  static constexpr Dice::hash::wyhash::int128 signaling_NaN() { return 0; }
  static constexpr Dice::hash::wyhash::int128 denorm_min() { return 0; }
};
}  // namespace std
